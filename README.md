...
- [PRODUCT VIDEO: FabGL Terminal Board with MBC2](https://www.youtube.com/watch?v=Ww_pH_ZOLqU)
...
- [TeleBASIC with FabGL graphics, sprite, and sound on TTGO VGA32 v1.4 (ESP32)](https://www.youtube.com/watch?v=YRwfwXCcyoI)

### Altair 8800 emulation:
- [Altair 8800 with FabGL (ESP32) - CP/M Navigating Emulator Settings](https://www.youtube.com/watch?v=MFYpXwqQZ_I)
...
- [FabGL ESP32 serial terminal: Playing with resolutions, fonts and colors, older model](https://www.youtube.com/watch?v=VylUOAgu9to)
- [How to use any VGA monitor as a serial terminal with VGA32 and FabGL (featuring IMSAI 8080)](https://www.youtube.com/watch?v=LOhmlOyUw4w)
- [Turn Any VGA Monitor into a RS232 Serial Terminal! Intro](https://www.youtube.com/watch?v=-SIB-rZcnWs)
...
### Vic20 emulation
- [FabGL embedded free VIC20 games](https://www.youtube.com/watch?v=ZW427HVWYys)
- [Emulate a Commodore VIC-20 on an ESP32 for $16](https://www.youtube.com/watch?v=Zvvdwd4t6gc)
- [How to install esp32 TTGO Micro 32 board + FabGL to Arduino IDE and setup Commodore VIC-20 emulator](https://www.youtube.com/watch?v=FXp4WoD9i7E)
- [TTGO VGA32 - Tiny ESP32 FabGL Development Board](https://www.youtube.com/watch?v=sCctddhJ8RA)
...
- [C64 in TTGO VGA32](http://www.retrowiki.es/viewtopic.php?f=86&t=200036016)
  
Youtube:
- [C64 emulator in real TTGO VGA32](https://www.youtube.com/watch?v=3VmYzMsAnps)
- [C64 in TTGO VGA32](https://www.youtube.com/watch?v=PPVfNmJeH-s)



### GameBoy emulation 
- [ESP32 Gameboy emulator](https://github.com/rpsubc8/esp32gameboy)
- [Multiples ROMS gameboy ESP32](https://www.youtube.com/watch?v=_zh5UDjzbNI)
...
- [ESP32 Lilygo (ttgo) vga32 module](https://www.youtube.com/watch?v=1OsNSaOi4_)

### German?
- [LILYGO TTGO ESP32 VGA32 Board V1.4](https://www.youtube.com/watch?v=3HJOkd05I8c)
- [TTGO VGA32 einfach phantastisch](https://youtu.be/NwkLWIhMKC8?si=waldFppAJXTXrSHI)
- [TTGO ESP32 VGA32 #13e FabGL Library Firmware DOS Programs and Games HDD](https://www.youtube.com/watch?v=YdbBVU368Jk)
- [TTGO ESP32 VGA32 #04 FabGL Library Firmware Altair 8800 Emulator](https://www.youtube.com/watch?v=sSP-DSnbs1g)
- [TTGO ESP32 VGA32 #13f 1 FabGL Library Firmware Windows 3 0 HDD](https://www.youtube.com/watch?v=7dLPnqFTNTs)
